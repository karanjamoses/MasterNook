 ...
 * This file demonstrates how to integrate Masternook with a web frontend
 */

// For React/Vue/Angular applications
export class MasternookClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new MasternookClient(provider, contractAddress);
